...
$.ui.intersect = (function() {
	...
	return function( draggable, droppable, toleranceMode ) {
    	...
    	if (droppable.options.iframeFix)
		    	{
		        var iframeOffset = $('iframe.active').offset(),
		      		iframeWidth = $('iframe.active').width(),
		      		iframeHeight = $('iframe.active').height(),
		      		iframeScrollTop = $('iframe.active').contents().scrollTop(),
		      		iframeScrollLeft = $('iframe.active').contents().scrollLeft();
